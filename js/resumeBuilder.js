...
function displayBio() {
    ...
    ("%data%", "http://www.hotmodelsactress.com/actors/images/Alec_Baldwin.jpg");
...
function displayEducation() {
    for (var indexCount = 0; indexCount < education.schools.length; indexCount++) {
        ...
        ("%data%", education.schools[indexCount].certification);
        ...
        ("%data%", education.schools[indexCount].subject);
        ...
        for (var indexCount = 0; indexCount < education.onlinecourses.length; indexCount++) {
            ...
            ("%data%", education.onlinecourses[indexCount].dates);
